...
def make_list(args):
    ...
    for i in range(args.chunks):
        ...
        if args.train_ratio == 1.0:
            ...
            if args.test_ratio:
                write_list(args.prefix + str_chunk + 'test.lst', chunk[:sep_test])
            if args.train_ratio + args.test_ratio < 1.0:
                write_list(args.prefix + str_chunk + 'val.lst', chunk[sep_test + sep:])
            write_list(args.prefix + str_chunk + 'train.lst', chunk[sep_test:sep_test + sep])
...
if __name__ == '__main__':
    args = parse_args()
    # args.list = True   #
    # args.prefix = 'F:\datasets\\20_faces_datasets\\'
    # args.root = 'F:\datasets\\20_faces_clip\\'
