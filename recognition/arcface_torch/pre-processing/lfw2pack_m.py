...
# txt_dir = r'F:\datasets\20_faces_datasets'
txt_dir = args.txt_dir
image_size = [int(x) for x in args.image_size.split(',')]
lfw_pairs = lfw.read_pairs(os.path.join(txt_dir, 'pairs.txt'))
lfw_paths, issame_list = lfw.get_paths(txt_dir, lfw_pairs, 'jpg')
lfw_bins = []
